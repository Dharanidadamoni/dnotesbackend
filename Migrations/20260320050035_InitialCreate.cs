        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SleepModeUntil = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageUnlocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessageUnlocks_Recipients_RecipientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageUnlocks_RecipientId",
